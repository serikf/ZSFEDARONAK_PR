*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSFE_V_CARD
*   generation date: 05.12.2021 at 18:53:17
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSFE_V_CARD         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSFE_V_CARD'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSFE_V_CARD_EXTRACT
TOTAL = ZSFE_V_CARD_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSFE_V_CARD'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSFE_V_CARD-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSFE_V_CARD_EXTRACT
TOTAL = ZSFE_V_CARD_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSFE_V_CARD-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSFE_V_CARD'
...
TOTAL = ZSFE_V_CARD_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSFE_V_CARD-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSFE_V_CARD-UPD_FLAG NE SPACE.
