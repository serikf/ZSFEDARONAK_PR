*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSFE_V_PRODUCT
*   generation date: 09.12.2021 at 11:05:41
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSFE_V_PRODUCT      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSFE_V_PRODUCT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSFE_V_PRODUCT_EXTRACT
TOTAL = ZSFE_V_PRODUCT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSFE_V_PRODUCT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSFE_V_PRODUCT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSFE_V_PRODUCT_EXTRACT
TOTAL = ZSFE_V_PRODUCT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSFE_V_PRODUCT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSFE_V_PRODUCT'
...
TOTAL = ZSFE_V_PRODUCT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSFE_V_PRODUCT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSFE_V_PRODUCT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSFE_V_PRODUCT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSFE_V_PRODUCT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSFE_V_PRODUCT_EXTRACT
TOTAL = ZSFE_V_PRODUCT_TOTAL
