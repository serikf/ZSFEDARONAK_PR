*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSFE_V_ORDER_PRO
*   generation date: 09.02.2022 at 02:39:05
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSFE_V_ORDER_PRO    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSFE_V_ORDER_PRO'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSFE_V_ORDER_PRO_EXTRACT
TOTAL = ZSFE_V_ORDER_PRO_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSFE_V_ORDER_PRO'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSFE_V_ORDER_PRO-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSFE_V_ORDER_PRO_EXTRACT
TOTAL = ZSFE_V_ORDER_PRO_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSFE_V_ORDER_PRO-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSFE_V_ORDER_PRO'
...
TOTAL = ZSFE_V_ORDER_PRO_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSFE_V_ORDER_PRO-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSFE_V_ORDER_PRO-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSFE_V_ORDER_PRO'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSFE_V_ORDER_PRO-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSFE_V_ORDER_PRO_EXTRACT
TOTAL = ZSFE_V_ORDER_PRO_TOTAL
